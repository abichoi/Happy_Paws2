                ...
                builder: (BuildContext context,
                  ...
                  if (!snapshot.hasData) {
                    ...
                    DocumentSnapshot _appointment =
                        snapshot.data!.docs[appointmentindex];
                    ...
                    if (_initialstarttime == 'empty') {
                      ...
                      pickedstartTime = DateTime(
                          ...
                          pickedstartDate.day,
                          int.parse(_initialstarttime.split(":")[0]),
                          int.parse(_initialstarttime.split(":")[1]));
                    }
                    if (_initialendtime == 'empty') {
                      ...
                      pickedendTime = DateTime(
                          ...
                          pickedendDate.month,
                          pickedendDate.day,
                          int.parse(_initialendtime.split(":")[0]),
                          int.parse(_initialendtime.split(":")[1]));
                    }
                    return Form(
                        key: _formKey,
                        child: SingleChildScrollView(
                            child: Column(
                                ...
                                onTap: () async {
                                  ...
                                  if (pickedDate != null) {
                                    ...
                                    setState(() {
                                      ...
                                      _initialstartdate = _formattedStartDate;
                                    });
                                  } else {
                              ...
                              TextFormField(
                                ...
                                decoration: const InputDecoration(
                                  hintText:
                                      'Please enter the start time (HHmm)',
                              ...
                              TextFormField(
                                ...
                                onTap: () async {
                                  ...
                                  if (pickedDate != null) {
                                    ...
                                    _formattedEndDate = DateFormat('yyyy-MM-dd')
                                        .format(pickedDate);

                                    setState(() {
                                      _enddate.text = _formattedEndDate;
                                      _initialenddate = _formattedEndDate;
                                    });
                                  } else {
                              ...
                              TextFormField(
                                ...
                                validator: (String? value) {
                                  ...
                                  } else if (pickedstartTime
                                      .isAfter(pickedendTime)) {
