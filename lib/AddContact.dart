                ...
                children: <Widget>[
                  ...
                  Wrap(spacing: 20, children: [
                    ...
                    FilterChip(
                        ...
                        labelStyle: TextStyle(
                          color:
                              _selectedBoarding ? Colors.white : Colors.black,
                        ),
                        selectedColor: Colors.deepPurpleAccent,
                        backgroundColor: Colors.white,
                        shape: RoundedRectangleBorder(
                        ...
                        onSelected: (bool selected2) {
                          setState(() {
                            ...
                            if (_selectedBoarding) {
                              ...
                              _choosen.removeWhere(
                                  (item) => item == 'Pet Boarding');
                            }
                          });
                        }),
                    FilterChip(
                        ...
                        onSelected: (bool selected3) {
                          setState(() {
                            ...
                            if (_selectedSitter) {
                              ...
                              _choosen
                                  .removeWhere((item) => item == 'Pet Sitter');
                            }
                          });
                        }),
                    FilterChip(
                  ...
                  TextFormField(
                    controller: _phone,
                    decoration: const InputDecoration(
                        hintText: 'Enter the phone number', labelText: 'Phone'),
                    validator: (String? value) {
                      if (value == null || value.isEmpty) {
                  ...
                  TextFormField(
                    controller: _email,
                    decoration: const InputDecoration(
                        hintText: 'Enter the email', labelText: 'Email'),
                    validator: (String? value) {
                      if (value == null || value.isEmpty) {
