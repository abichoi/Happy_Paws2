                ...
                child: StreamBuilder<QuerySnapshot>(
                    ...
                    builder: (context, snapshot) {
                      if (!snapshot.hasData) {
                        ...
                        DocumentSnapshot _contact =
                            snapshot.data!.docs[contactindex];
                        ...
                        if (_name.text == '') {
                          ...
                          _selectedGroomer =
                              _contact.get("selectedGroomer") == 'true'
                                  ? true
                                  : false;
                          _selectedBoarding =
                              _contact.get("selectedBoarding") == 'true'
                                  ? true
                                  : false;
                          _selectedSitter =
                              _contact.get("selectedSitter") == 'true'
                                  ? true
                                  : false;
                          _selectedVet = _contact.get("selectedVet") == 'true'
                              ? true
                              : false;
                          _selectedOther =
                              _contact.get("selectedOther") == 'true'
                                  ? true
                                  : false;
                        }
