...
//medical record page: show the records

class MedRecPage extends StatefulWidget {
  const MedRecPage({Key? key}) : super(key: key);
                                  ...
                                  IconButton(
                                    ...
                                    onPressed: () {
                                      FirebaseFirestore.instance
                                          ...
                                          .doc(petdocid)
                                          .update({
                                        'MedRec': FieldValue.arrayRemove(
                                            [petmedreclist[_index]])
                                      });
                                    },
                                  ),
                                ]),
