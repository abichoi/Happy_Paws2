...
//homepage: show pet profiles, contacts
...
class _HomePageState extends State<HomePage> {
  final title1_Home = const Text(
    'Pet Profiles',
    style: TextStyle(fontSize: 40.0, fontWeight: FontWeight.bold),
  );
  final title2_Home = const Text(
    'Contact',
    style: TextStyle(fontSize: 40.0, fontWeight: FontWeight.bold),
  );
...
//generate the horizontal list for pet profiles
...
var contactindex = 0;
//generate the vertical list for contacts
